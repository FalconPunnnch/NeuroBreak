// HU03 OAuth - RegisterPage (Google y Microsoft solamente)
// frontend/src/presentation/pages/public/RegisterPage/RegisterPage.jsx
...
const RegisterPage = () => {
  ...
  // OAuth Functions (Solo Google y Microsoft)
          ...
          <div className="register-form-wrapper">
            <div className="register-form-container">
              ...
              <form onSubmit={handleSubmit} className="register-form">
                ...
                {/* OAuth Buttons - Solo Google y Microsoft */}
