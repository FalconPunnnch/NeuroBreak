// Auth Controller - Con validación OAuth en forgot-password
// backend/src/infrastructure/api/controllers/AuthController.js
...
class AuthController {
  ...
  async login(req, res) {
    try {
      ...
      // ✅ VALIDAR SI ES USUARIO OAUTH (sin contraseña)
      if (!user.password) {
        return res.status(401).json({
          success: false,
  ...
  // ============================================
  // OAUTH METHODS - Google y Microsoft
  // ============================================

  // Callback de Google OAuth - Manejado por Passport
  ...
  // Callback de Microsoft OAuth - Manejado por Passport
