...
import { CatalogProvider, useCatalogContext } from '../../../../state/contexts/catalog/CatalogContext.js';
        ...
        <div className="microactivity-detail-page__content">
          ...
          <div className="microactivity-detail-page__info">
            <div className="microactivity-detail-page__info-card">
              <h3>¿Qué necesitas?</h3>
              <ul>
                <li>Un espacio cómodo y tranquilo</li>
                <li>{durationLabel} de tiempo disponible</li>
                <li>Actitud positiva y ganas de relajarte</li>
              </ul>
            </div>
            <div className="microactivity-detail-page__info-card">
              <h3>Beneficios</h3>
              <ul>
                ...
                <li>Aumenta el bienestar general</li>
              </ul>
            </div>
          </div>
        </div>
