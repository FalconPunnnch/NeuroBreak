...
import useActivityTimer from 'hooks/shared/useActivityTimer';
import ActivityTimer from 'components/features/activity/ActivityTimer';
import EmotionModal from 'components/features/modals/EmotionModal';
...
function ActivityRunnerPage() {
  ...
  const handleReset = useCallback(async () => {
    try {
      await resetTimer();
      // Re-inicializar el timer con la actividad y duración actual
      if (activity) {
        initializeTimer(activity, 'countdown');
        startTimer();
      }
  ...
  }, [resetTimer, initializeTimer, startTimer, activity]);
